      ...
      {showPopup && (
        <div className="no-print fixed inset-0 z-[999] flex items-center justify-center p-5">
          ...
          <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-sm p-8 text-center animate-[fadeInUp_0.3s_ease] max-h-[90vh] overflow-y-auto">
            ...
            <h3 className="text-xl font-black text-indigo-950 mb-2">Receive Your Report</h3>
            <p className="text-sm text-gray-500 leading-relaxed mb-5">
              Enter your email to receive your free results report.
            </p>
      ...
      <div className="min-h-screen bg-gradient-to-b from-violet-50 to-gray-50">
        <div ref={reportRef} className="max-w-xl mx-auto px-5 pb-16">
          ...
          <div className="relative w-full rounded-3xl overflow-hidden mb-6 shadow-2xl mt-6" style={{ aspectRatio: '9/13' }}>
            <img src={heroImg} alt="EgoXLove result" className="absolute inset-0 w-full h-full object-cover" />
          ...
          {/* Avatar, radar, pillar bars — always shown */}
          ...
          {!user?.isPremium && (
            <div className="no-print relative overflow-hidden bg-gradient-to-br from-indigo-950 via-purple-900 to-violet-900 rounded-3xl p-8 text-white text-center shadow-2xl mb-6">
              ...
              <Link to="/subscription" className="text-xs text-white/60 hover:text-white/90 transition underline underline-offset-2">
