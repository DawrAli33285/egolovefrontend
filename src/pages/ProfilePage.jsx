...
if (!res.ok) throw new Error('Update failed')
  ...
  const avatarUrl = updatedUser.avatar
    ...
    : user.avatarUrl
  if (setUser) setUser({ ...user, ...updatedUser, avatarUrl })
 ...
 <ToastContainer containerId="profile"  autoClose={3000} />     
            ...
            <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
              ...
              {!editMode ? (
                <button
                  ...
                  className="text-xs font-semibold px-3 py-1.5 rounded-xl bg-violet-100 text-violet-700 hover:bg-violet-200 transition"
                >
                ...
                <button
                  ...
                  className="text-xs font-semibold px-3 py-1.5 rounded-xl bg-gray-100 text-gray-500 hover:bg-gray-200 transition"
                >
  ...
  <div className="flex flex-col gap-1.5">
    ...
    <button
      ...
      className="text-xs font-semibold text-violet-600 bg-violet-50 hover:bg-violet-100 px-3 py-1.5 rounded-xl transition"
    >
      📷 Camera
    </button>
  </div>
  ...
  <span className="text-xs text-gray-300 font-medium">🔒</span>
            ...
            <div className="px-5 py-4 border-b border-gray-100">
              ...
              <input
                ...
                readOnly={!editMode}
                className={editMode ? inputEditable : inputReadonly}
              />
            </div>
            ...
            <div className="px-5 py-4 border-b border-gray-100">
              ...
              {editMode ? (
                <input
                  ...
                  placeholder={t('profile.passwordPlaceholder') || 'Enter new password…'}
                ...
                <input
                  ...
                  value="placeholder"
                  readOnly
                  className={`${inputReadonly} tracking-widest text-gray-300`}
                />
              )}
            </div>
            ...
            {editMode && (
              <div className="px-5 py-4">
                {saveError && (
                  <p className="text-xs text-red-500 mb-3">⚠️ {saveError}</p>
                )}
                {saveSuccess && (
                  <p className="text-xs text-emerald-600 mb-3">✅ {t('profile.saveSuccess') || 'Profile updated!'}</p>
                )}
                <button
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-white rounded-2xl p-4 shadow-sm border border-emerald-100">
                ...
                <div className="text-base font-black text-indigo-950">
                  {best.icon} {t(`pillars.${best.id}.name`)}
                </div>
              ...
              <div className="bg-white rounded-2xl p-4 shadow-sm border border-amber-100">
                ...
                <div className="text-base font-black text-indigo-950">
                  {worst.icon} {t(`pillars.${worst.id}.name`)}
                </div>
        ...
        <div className="mb-5">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden divide-y divide-gray-100">
            ...
            <Link to="/quiz" className="flex items-center gap-3 px-5 py-4 hover:bg-violet-50 transition group">
            ...
            {freeResults && (
              <Link to="/results" className="flex items-center gap-3 px-5 py-4 hover:bg-violet-50 transition group">
                <span className="w-9 h-9 rounded-xl bg-violet-100 flex items-center justify-center text-base group-hover:bg-violet-200 transition">📊</span>
                <div className="flex-1">
            ...
            {subscribed ? (
              <Link to="/premium-quiz" className="flex items-center gap-3 px-5 py-4 hover:bg-yellow-50 transition group">
              ...
              <Link to="/subscription" className="flex items-center gap-3 px-5 py-4 hover:bg-yellow-50 transition group">
                <span className="w-9 h-9 rounded-xl bg-yellow-100 flex items-center justify-center text-base group-hover:bg-yellow-200 transition">🔒</span>
                <div className="flex-1">
            ...
            {premiumResults && (
              <Link to="/premium-report" className="flex items-center gap-3 px-5 py-4 hover:bg-violet-50 transition group">
            ...
            <Link to="/subscription" className="flex items-center gap-3 px-5 py-4 hover:bg-violet-50 transition group">
              <span className="w-9 h-9 rounded-xl bg-indigo-100 flex items-center justify-center text-base group-hover:bg-indigo-200 transition">💳</span>
              <div className="flex-1">
    ...
    <div className="bg-white rounded-3xl overflow-hidden w-full max-w-sm shadow-2xl">
      ...
      <div className="p-4">
        <button
          ...
          className="w-full py-3 text-sm font-bold text-white bg-gradient-to-r from-violet-600 to-purple-600 rounded-xl hover:opacity-90 transition"
        >
          📸 Capture Photo
        </button>
      </div>
